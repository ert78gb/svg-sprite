...
function SVGSpriterConfig(config) {
    ...
    this.shape = Object.prototype.hasOwnProperty.call(config, 'shape') ? ({ ...config.shape || {} }) : {};
    ...
    if (!Object.prototype.hasOwnProperty.call(this.shape, 'sort') || !_.isFunction(this.shape.sort)) {
        this.shape.sort = (shape1, shape2) => shape1.id === shape2.id ? 0 : (shape1.id > shape2.id ? 1 : -1);
    }

    // Intermediate SVG destination
    this.shape.dest = Object.prototype.hasOwnProperty.call(this.shape, 'dest') ? String(this.shape.dest).trim() : '';
    this.shape.dest = this.shape.dest.length ? path.resolve(this.dest, this.shape.dest) : null;

    // Expand spacing options to arrays
    this.shape.spacing = Object.prototype.hasOwnProperty.call(this.shape, 'spacing') ? (this.shape.spacing || {}) : {};
    ...
    if (Object.prototype.hasOwnProperty.call(this.shape, 'transform') && Array.isArray(this.shape.transform)) {
    ...
    this.svg = Object.prototype.hasOwnProperty.call(config, 'svg') ? Object.assign(this.svg, config.svg || {}) : this.svg;
    ...
    transforms = [];
    if (Object.prototype.hasOwnProperty.call(this.svg, 'transform')) {
