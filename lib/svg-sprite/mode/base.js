...
function SVGSpriteBase(spriter, config, data, key) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.config, 'sprite')) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.config, 'render') && _.isObject(this.config.render)) {
        for (const extension in this.config.render) {
            ...
            if (_.isObject(this.config.render[extension])) {
                if (Object.prototype.hasOwnProperty.call(this.config.render[extension], 'template')) {
                    renderConfig.template = path.resolve(process.cwd(), this.config.render[extension].template);
                }

                if (Object.prototype.hasOwnProperty.call(this.config.render[extension], 'dest')) {
        ...
        this._cssDest = Object.prototype.hasOwnProperty.call(this.config.render, 'css') ?
...
SVGSpriteBase.prototype._initData = function(data) {
    ...
    if (this.config.example) {
        ...
        if (_.isObject(this.config.example)) {
            if (Object.prototype.hasOwnProperty.call(this.config.example, 'template')) {
                renderConfig.template = path.resolve(process.cwd(), this.config.example.template);
            }

            if (Object.prototype.hasOwnProperty.call(this.config.example, 'dest')) {
