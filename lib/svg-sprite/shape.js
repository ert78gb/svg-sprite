...
function SVGShape(file, spriter) {
    ...
    this.meta = Object.prototype.hasOwnProperty.call(this.config.meta, this.id) ? this.config.meta[this.id] : (Object.prototype.hasOwnProperty.call(this.config.meta, relative) ? this.config.meta[relative] : {});
    this.align = Object.entries({ ...this.config.align['*'], ...(Object.prototype.hasOwnProperty.call(this.config.align, this.id) ? this.config.align[this.id] : (Object.prototype.hasOwnProperty.call(this.config.align, relative) ? this.config.align[relative] : {})) });
...
SVGShape.prototype._stripInlineNamespaceDeclarations = function(element, nsMap) {
    ...
    if (!Object.prototype.hasOwnProperty.call(nsMap, 'xlink') || nsMap.xlink === this.XLINK_NAMESPACE) {
...
SVGShape.prototype._addMetadata = function(cb) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.meta, 'description') && _.isString(this.meta.description) && this.meta.description.length) {
        if (!this.description) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.meta, 'title') && _.isString(this.meta.title) && this.meta.title.length) {
        if (!this.title) {
    ...
    if (!this._namespaced && (namespaceIds || namespaceClassnames)) {
        ...
        if (namespaceIds) {
            ...
            select('//@xlink:href', this.dom).forEach(xlink => {
                ...
                if (!xlinkValue.startsWith('data:') && Object.prototype.hasOwnProperty.call(substIds, xlinkValue)) {
            ...
            if (this.dom.documentElement.hasAttribute('aria-labelledby')) {
                this.dom.documentElement.setAttribute('aria-labelledby', this.dom.documentElement.getAttribute('aria-labelledby').split(' ').map(label => {
                    return '#' + Object.prototype.hasOwnProperty.call(substIds, label) ? substIds['#' + label] : label;
                }).join(' '));
            }
        }
...
SVGShape.prototype._replaceIdAndClassnameReferences = function(str, substIds, substClassnames, selectors) {
    ...
    if (substIds !== null) {
        str = str.replace(/url\s*\(\s*["']?([^\s"')]+)["']?\s*\)/g, (match, id) => {
            return 'url(' + (Object.prototype.hasOwnProperty.call(substIds, id) ? '#' + substIds[id] : id) + ')';
        });
    }
    ...
    rules.forEach(rule => {
        ...
        // Regular selector
            ...
            const classnameFilter = classname => {
                if (Object.prototype.hasOwnProperty.call(substClassnames, '.' + classname)) {
            ...
            const idOrClassSubstitution = sel => {
                ...
                if (Object.prototype.hasOwnProperty.call(sel.rule, 'id') && substIds !== null && '#' + Object.prototype.hasOwnProperty.call(substIds, sel.rule.id)) {
                    ids.push(sel.rule.id);
                }

                // If class name substitution should be applied: Search for class names
                if (Object.prototype.hasOwnProperty.call(sel.rule, 'classNames') && substClassnames !== null && Array.isArray(sel.rule.classNames)) {
            ...
            if (Object.prototype.hasOwnProperty.call(sel, 'selectors')) {
            ...
            while (typeof sel === 'object' && Object.prototype.hasOwnProperty.call(sel, 'rule')) {
